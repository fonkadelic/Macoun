...
extension Speaker {
    ...
    static let allSpeakers = [
        Speaker(
            ...
            imageResource: #imageLiteral(resourceName: "andreas")
        ),
        Speaker(
            id: 2,
            ...
            imageResource: #imageLiteral(resourceName: "ashley")
        ),
        Speaker(
            id: 3,
            name: "Charles Perry",
            ...
            imageResource: #imageLiteral(resourceName: "charles")
        ),
        Speaker(
            id: 4,
            name: "Clay Smith",
            ...
            imageResource: #imageLiteral(resourceName: "clay")
        ),
        Speaker(
            id: 5,
            ...
            imageResource: #imageLiteral(resourceName: "daniel")
        ),
        Speaker(
            id: 6,
            name: "Dasmer Singh",
            ...
            imageResource: #imageLiteral(resourceName: "dasmer")
        ),
        Speaker(
            id: 7,
            name: "Ellen Shapiro",
            ...
            imageResource: #imageLiteral(resourceName: "ellen")
        ),
        Speaker(
            id: 8,
            ...
            imageResource: #imageLiteral(resourceName: "jaimee")
        ),
        Speaker(
            id: 9,
            name: "Jeff Watkins",
            ...
            imageResource: #imageLiteral(resourceName: "jeff")
        ),
        Speaker(
            id: 10,
            ...
            imageResource: #imageLiteral(resourceName: "bernhard-mathias")
        ),
        Speaker(
            id: 11,
            name: "Laura Savino",
            ...
            imageResource: #imageLiteral(resourceName: "laura")
        ),
        Speaker(
            id: 12,
            name: "Michael May",
            ...
            imageResource: #imageLiteral(resourceName: "michael")
        ),
        Speaker(
            id: 13,
            ...
            imageResource: #imageLiteral(resourceName: "shuichi")
        ),
        Speaker(
            id: 14,
            name: "Stephen Barnes",
            ...
            imageResource: #imageLiteral(resourceName: "stephen")
        ),
        Speaker(
            id: 15,
            name: "Steve Scott",
            ...
            imageResource: #imageLiteral(resourceName: "steve")
        ),
    ]
}
